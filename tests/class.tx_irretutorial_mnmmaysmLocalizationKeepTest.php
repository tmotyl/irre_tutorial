...
/**
 * Testcase for m:n MM localizations using localizationMode 'keep'.
 *
 * @author Oliver Hader <oliver@typo3.org>
 */
class tx_irretutorial_mnmmaysmLocalizationKeepTest extends tx_irretutorial_AbstractLocalization {
