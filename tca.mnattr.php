...
$TCA["tx_irretutorial_mnattr_hotel_offer_rel"] = Array (
	...
	"columns" => Array (
		...
		"quality" => Array (
			"exclude" => 1,
			"label" => "LLL:EXT:irre_tutorial/locallang_db.xml:tx_irretutorial_hotel_offer_rel.quality",
			"config" => Array (
				"type" => "select",
				"items" => Array (
					Array("LLL:EXT:irre_tutorial/locallang_db.xml:tx_irretutorial_hotel_offer_rel.quality.I.0", "1"),
					Array("LLL:EXT:irre_tutorial/locallang_db.xml:tx_irretutorial_hotel_offer_rel.quality.I.1", "2"),
					Array("LLL:EXT:irre_tutorial/locallang_db.xml:tx_irretutorial_hotel_offer_rel.quality.I.2", "3"),
					Array("LLL:EXT:irre_tutorial/locallang_db.xml:tx_irretutorial_hotel_offer_rel.quality.I.3", "4"),
					Array("LLL:EXT:irre_tutorial/locallang_db.xml:tx_irretutorial_hotel_offer_rel.quality.I.4", "5"),
				),
			)
		),
		"allincl" => Array (
			"exclude" => 1,
			"label" => "LLL:EXT:irre_tutorial/locallang_db.xml:tx_irretutorial_hotel_offer_rel.allincl",
			"config" => Array (
				"type" => "check",
			)
		),
	...
	"types" => Array (
		"0" => Array("showitem" => "sys_language_uid;;;;1-1-1, l18n_parent, l18n_diffsource, hidden;;1, title;;;;2-2-2, hotelid;;;;3-3-3, offerid, hotelsort, offersort, quality, allincl")
	),
	"palettes" => Array (
		"1" => Array("showitem" => "")
	)
